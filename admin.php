                ...
                <div class="x_panel">
                  ...
                  <div class="tile_count">
                    <div class="col-md-2 col-sm-4  tile_stats_count">
                      ...
                      <div class="count green"><?php echo $hu ?></div>
                      <br>
                      <button type="button" class="btn btn-primary btn-sm" onclick="document.location.href='viewuser.php'">Lihat : </button>
                    </div>
                    <div class="col-md-2 col-sm-4  tile_stats_count">
                      <span class="count_top"><i class="fa fa-comments"></i> Total Gejala</span>
                      <div class="count green"><?php echo $hg ?></div>
                      <br>
                      <button type="button" class="btn btn-primary btn-sm" onclick="document.location.href='viewgejala.php'">Lihat : </button>
                    </div>
                    <div class="col-md-2 col-sm-4  tile_stats_count">
                      <span class="count_top"><i class="fa fa-balance-scale"></i> Total Penyakit</span>
                      <div class="count green"><?php echo $hp ?></div>
                      <br>
                      <button type="button" class="btn btn-primary btn-sm" onclick="document.location.href='viewpenyakit.php'">Lihat : </button>
                    </div>
                    <div class="col-md-2 col-sm-4  tile_stats_count">
                      <span class="count_top"><i class="fa fa-book"></i> Total Basis Pengetahuan</span>
                      <div class="count green"><?php echo $hr ?></div>
                      <br>
                      <button type="button" class="btn btn-primary btn-sm" onclick="document.location.href='knowledge.php'">Lihat : </button>
                    </div>
                    <div class="col-md-2 col-sm-4  tile_stats_count">
                      <span class="count_top"><i class="fa fa-history"></i> Total Riwayat Diagnosis</span>
                      <div class="count green"><?php echo $hh ?></div>
                      <br>
                      <button type="button" class="btn btn-primary btn-sm" onclick="document.location.href='history.php'">Lihat : </button>
                    </div>
                    <!-- <div class="col-md-2 col-sm-4  tile_stats_count">
                    ...
                    <div class="col-md-2 col-sm-4  tile_stats_count">
                      ...
                      <br>
                      <button type="button" class="btn btn-primary btn-sm" onclick="document.location.href='viewartikel.php'">Lihat : </button>
                    </div>
                  </div>
                </div>
